...
class TestFilms:
    ...
    def test_get_films_with_db(self, app_dev, api_ver):
        client = app_dev.test_client()
        resp = client.get(f'{api_ver}/films')
        assert resp.status_code == http.HTTPStatus.OK

    def test_create_film_with_db(self, app_dev, api_ver):
        client = app_dev.test_client()
        data = {
            'title': 'Test Title',
    ...
    def test_update_film_with_db(self, app_dev, api_ver):
        client = app_dev.test_client()
    ...
    def test_delete_film_with_db(self, app_dev, api_ver):
        client = app_dev.test_client()
        url = f'{api_ver}/films/{self.uuid[0]}'
